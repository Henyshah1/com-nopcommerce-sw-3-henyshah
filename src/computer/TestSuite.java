...
public class TestSuite extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() {
        ...
        s1 = getTextElement(By.xpath("//option[contains(text(),'Name: Z to A')]"));
        clickOnElement(By.xpath(" //option[contains(text(),'Name: Z to A')]"));

        //Verify the product will arrange in Descending order.
        expectedTest = "Name: Z to A";
        actualText = getTextElement(By.xpath("//option[contains(text(),'Name: Z to A')]"));
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        String actualResult = getTextElement(By.xpath("//h1[contains(text(),'Build your own computer')]"));
        ...
        String actualPrice = getTextElement(By.xpath("//*[@id=\"price-value-1\"]"));
        ...
        String actualText = getTextElement(By.xpath("//body/div[@id='bar-notification']/div[1]/p[1]"));
        ...
        String actualShoppingCart = getTextElement(By.xpath("//h1[contains(text(),'Shopping cart')]"));
        ...
        String actualTotal = getTextElement(By.xpath("//*[@id=\"shopping-cart-form\"]/div[3]/div[2]/div[1]/table/tbody/tr[4]/td[2]/span/strong"));
        ...
        String actualSignInMessage = getTextElement(By.xpath("//h1[contains(text(),'Welcome, Please Sign In!')]"));
        ...
        //Add first name
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Heny");

        //Add Last name
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Shah");

        //Add email address
        sendTextToElement(By.id("BillingNewAddress_Email"), "Henyshah1@gmail.com");
        ...
        sendTextToElement(By.id("CardholderName"), "Heny");

        //Add card number
        sendTextToElement(By.id("CardNumber"), "5555555335554444");
        ...
        String actualPaymentMethod = getTextElement(By.xpath("//*[@id=\"checkout-confirm-order-load\"]/div/div/div/div/div[1]/div[2]/ul/li/span[2]"));
        ...
        String actualShippingMethod = getTextElement(By.xpath("//*[@id=\"checkout-confirm-order-load\"]/div/div/div/div/div[2]/div[2]/ul/li/span[2]"));
        ...
        String actualTotalFinal = getTextElement(By.xpath("//*[@id=\"shopping-cart-form\"]/div[3]/div/div/table/tbody/tr[4]/td[2]/span/strong"));
        ...
        String actualThanks = getTextElement(By.xpath("//h1[contains(text(),'Thank you')]"));
        ...
        String actualOrderMessage = getTextElement(By.xpath("//strong[contains(text(),'Your order has been successfully processed!')]"));
        ...
        String actualWelcomeMessage = getTextElement(By.xpath("//h2[contains(text(),'Welcome to our store')]"));
