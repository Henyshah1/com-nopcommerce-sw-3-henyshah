...
public class ElectronicsTest extends Utility {
    ...
    public void verifyUserShouldNavigateToCellPhonesPageSuccessfully() throws InterruptedException {
        ...
        String actualTxt = getTextElement(By.xpath("//h1[normalize-space()='Cell phones']"));
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        String actualMessage = getTextElement(By.xpath("//h1[normalize-space()='Cell phones']"));
        ...
        String actualText = getTextElement(By.xpath("//h1[normalize-space()='Nokia Lumia 1020']"));
        ...
        String actualPrice = getTextElement(By.xpath("//span[@id='price-value-20']"));
        ...
        String actMessage = getTextElement(By.xpath("//div[@id='bar-notification']"));
        ...
        String actualMsg = getTextElement(By.xpath("//h1[normalize-space()='Shopping cart']"));
        ...
        String actualTotal = getTextElement(By.xpath("//span[@class='product-subtotal']"));
        ...
        String actualTxt = getTextElement(By.xpath("//h1[normalize-space()='Welcome, Please Sign In!']"));
        ...
        String actualT = getTextElement(By.xpath("//h1[normalize-space()='Register']"));
        ...
        actualMessage = getTextElement(By.xpath("//div[@class='result']"));
        verifyText("Expected text is not displayed", expectedMessage, actualMessage);
        ...
        actualMessage = getTextElement(By.xpath("//h1[normalize-space()='Shopping cart']"));
        ...
        actualMessage = getTextElement(By.xpath("//span[normalize-space()='Credit Card']"));
        verifyText("Expected text is not matching", expectedMessage, actualMessage);

        expectedMessage = "2nd Day Air";
        actualMessage = getTextElement(By.xpath("//span[normalize-space()='2nd Day Air']"));
        verifyText("Expected text is not matching", expectedMessage, actualMessage);

        expectedMessage = "$698.00";
        actualMessage = getTextElement(By.xpath("//span[@class='product-subtotal']"));
        verifyText("Expected text is not matching", expectedMessage, actualMessage);

        clickOnElement(By.xpath("//button[normalize-space()='Confirm']"));

        String expectedMessage9 = "Thank you";
        String actualMessage9 = getTextElement(By.xpath("//h1[normalize-space()='Thank you']"));
        ...
        actualMessage = getTextElement(By.xpath("//strong[normalize-space()='Your order has been successfully processed!']"));
        verifyText("Expected text is not matching", expectedMessage, actualMessage);

        clickOnElement(By.xpath("//button[normalize-space()='Continue']"));

        expectedMessage = "Welcome to our store";
        actualMessage = getTextElement(By.xpath("//h2[normalize-space()='Welcome to our store']"));
        verifyText("Expected text is not matching", expectedMessage, actualMessage);

        expectedMessage = "Log out";
        actualMessage = getTextElement(By.xpath("//a[normalize-space()='Log out']"));
        verifyText("Expected text is not matching", expectedMessage, actualMessage);
